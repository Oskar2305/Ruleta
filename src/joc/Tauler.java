            ...
            switch (selectOpcio) {
                ...
                case 1:
                    ...
                    while (!fin){
                        ...
                        try {
                            num = n.nextInt();
                            if (num>0 && num<=36) fin = true;
                            else System.out.println("Introdueix un numero VALID (0-36)");
                        } catch (Exception e) {
                ...
                case 3:
                    ...
                    do {
                        ...
                        System.out.println("Introdueix a que apostes: Negre o Vermell");
                        color = n.next().toLowerCase();
                        aux++;
                    } while (!color.equals("Negre") && !color.equals("Vermell"));
                    Color colorF = (color.toLowerCase().equals("vermell")) ? Color.VERMELL : Color.NEGRE;
                    aux = 0;
                    do {
                        System.out.println("Tens " + player.getMoney() + "€");
                        if (aux > 0) {
                    ...
                    System.out.println("La bola ha caigut a " + this.getCaselles()[tirada]);
                    if (this.getCaselles()[tirada].getColor().equals(colorF)) {
